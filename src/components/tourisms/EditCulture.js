...
import { editCulture } from "../../store/actions/tourismAction";
          ...
          <div className="page-header">
            ...
            <ul className="breadcrumbs">
              ...
              <li className="nav-item">
                <a href="url">Form masukan Edit wisata Budaya</a>
              </li>
            </ul>
          </div>
          <div className="row">
              ...
              <div className="card">
                <div className="card-header bg-primary">
                  <div className="card-title text-white ">
                    Form masukan Edit wisata Budaya
                  </div>
                </div>
...
const mapStateToProps = (state) => {
  ...
  const mapDispatchToProps = (dispatch) => {
    return {
      editCulture: (tourism) => dispatch(editCulture(tourism)),
    };
  };
  
export default connect(mapStateToProps, mapDispatchToProps) (EditCulture);
