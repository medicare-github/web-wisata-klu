...
import { editCulinary } from "../../store/actions/tourismAction";
...
class EditCulinary extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      name: "",
    ...
    ref.get().then((doc) => {
      if (doc.exists) {
        ...
        this.setState({
          ...
          priceStart: documents.priceStart,
          priceEnd: documents.priceEnd,
          url: documents.image,
          id: doc.id,
        });
      } else {
...
const mapDispatchToProps = (dispatch) => {
  return {
    editCulinary: (tourism) => dispatch(editCulinary(tourism)),
  };
};

export default connect(mapStateToProps, mapDispatchToProps)(EditCulinary);
